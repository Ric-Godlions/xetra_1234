...
class TestS3BucketConnectosMethods(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        self.s3_secret_key = "AWS_SECRET_ACCESS_KEY_ID"
    ...
    def test_list_files_in_prefix_ok(self):
        """
        Tests the list_files_in_prefix methos for getting 2 file keys
        as list on the mocket s3 bucket
        """
        # Expected results
        prefix_exp = 'prefix/'
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Tests the list_files_in_prefix methos in case of a wrong or not existing prefix
        """
        # Expected results
