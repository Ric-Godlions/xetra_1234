...
class XetraETL():
    ...
    def __init__(self, s3_buscket_src: S3BucketConnector, s3_buscket_trg: S3BucketConnector, meta_key: str, src_args: XetraSourceConfig,
                 trg_args: XetraTargetConfig) -> None:
        """
        ...
        self.s3_buscket_src = s3_buscket_src
        self.s3_buscket_trg = s3_buscket_trg
